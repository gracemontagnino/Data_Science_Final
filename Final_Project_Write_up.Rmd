...
* Spending and income are associated (at least for some categories)
* Most categories decreased over time, except for SNAP
* Social infrastructure tends to be more positively correlated whereas cash assistance programs are negatively correlated (social infrastructure = libraries, parks and rec, public health, HCD)
